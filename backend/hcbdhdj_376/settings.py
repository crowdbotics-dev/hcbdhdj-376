"""
Django settings for hcbdhdj_376 project.
...
WSGI_APPLICATION = 'hcbdhdj_376.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hcbdhdj_376 API",
    "DESCRIPTION": "API documentation for hcbdhdj_376 App",
    "VERSION": "v1",
}
